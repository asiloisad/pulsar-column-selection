...
- **cursor-leader compatibility**: Works correctly alongside [cursor-leader](https://github.com/asiloisad/pulsar-cursor-leader), including when power mode is active.
